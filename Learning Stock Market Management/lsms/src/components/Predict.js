    ...
    if (true) {
      ...
      try {
        ...
        const predictionResponse = await fetch(
          `http://localhost:5000/predictstock/${startDate}/${endDate}/${symbol}`,
          {
            method: 'POST',
            headers: {
                ...
                <div className="flex">
                  <div className=" w-4/12 h-16  ">
                    ...
                    <SearchableSelect
                      ...
                      className="form-control bg-dark border-0 w-full h-full"
                    />
                  </div>
                  ...
                  <div className=" w-2/12 h-16 ">
                    <button
                      className="form-control  text-white    mt-[23px] "
                      style={{ background: '#EB1616' }}
                      onClick={() =>
                        predictStockPrice(startDate, endDate, selectedStock)
                      }
                    >
                      Get Result
                    </button>
              ...
              <div className="bg-secondary text-center rounded p-4">
                ...
                {!loading &&
                  ...
                  predictionData.length > 0 && (
                    <>
                      <h2>
                        Prediction Data for {selectedStock} ({})
                      </h2>
                      <StockChart
                      ...
                      <p className="text-red-700">
                        Disclaimer: This prediction tool is for educational
                        purposes only. Investing in stocks involves risks, and
                        decisions should be made based on careful research and
                        consideration. Use this information at your own risk.
                      </p>
                    </>
                  )}
          ...
          <div className="bg-secondary rounded-top p-4">
            <div className="row">
              ...
              <div className="col-12 col-sm-6 text-center text-sm-end">
                Designed By{' '}
                <a href="https://portfolio-website-azure-eta.vercel.app/">
                  Kumar Laxmikant
                </a>
              </div>
            </div>
